...
const UserProfile = () => {
  ...
  const [text, setText] = useState('Ваши публикации');
  ...
  if (!user) return <Spinner message="Загружаем профиль..." />;
    ...
    <div className="relative pb-2 h-full justify-center items-center">
      <div className="flex flex-col pb-5">
        <div className="relative flex flex-col mb-7">
          ...
          <div className="flex justify-center top-0 z-1 right-0 p-2">
